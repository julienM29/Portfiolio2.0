    ...
    <header role="banner" className="fixed top-0 left-0 w-full z-50 bg-transparent flex items-center h-32 justify-center">
      ...
      >
        ...
        <a
          ...
          className={`cursor-pointer text-lg font-semibold transition-transform duration-300 hover:scale-110 ${isLight ? 'text-neutral-600 hover:text-neutral-900' : 'text-neutral-300 hover:text-white'}`}
        >
          <img
        ...
        <button
          ...
          onClick={setIsLight}
          className={`transition-transform duration-200 hover:scale-110 hover:cursor-pointer border rounded-full p-2 ${isLight ? 'text-black border-neutral-700/60' : 'text-white border-white/90'}`}
        >
