...
function Footer({ isLight }) {
  return (
    <footer
      id="footer"
      role="contentinfo"
      className={`flex flex-col sm:flex-row justify-between items-center gap-4 sm:gap-8 py-10 px-4 ${isLight ? "text-light-primary" : "text-dark-primary"}`}
    >
      ...
      <div className="flex flex-wrap gap-3 sm:gap-4 items-center justify-center sm:justify-start">
        ...
        <a
          href="https://github.com/julienM29"
          target="_blank"
          rel="noopener noreferrer"
